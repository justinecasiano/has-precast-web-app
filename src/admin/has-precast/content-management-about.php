<?php
  ...
  $about = $getContent->getPage("about");
?>
...
<body>
  ...
  <main>
    <div class="main-header">
      <h1>Content Management - About Us</h1>
    </div>
    ...
    <div class="table-wrapper">
      <div>
        ...
        <div class="edit-buttons">
          <form action="edit-content.php?page=about" method="post">
            <button type="submit">Edit Page</button>
          </form>
          <a href="includes/content/default-content.inc.php?page=about"><button>Reset to Default</button></a>
        </div>
      </div>
      <div class="table">
        <table>
          ...
          foreach($about as $content){
            ...
            if($content['type'] != "TEXT"){
              $object = "
                <img id='media' src='images/temp/about-us/{$content['object']}'>
              ";
            }
            else{
            ...
            echo "
              <tbody>
                <tr>
                  <td>
                    <a href='includes/content/default-content.inc.php?page=about&section={$content['section']}&name={$content['name']}'>Default</a>
                  </td>
                  <td>
                    $content[section]
                  </td>
