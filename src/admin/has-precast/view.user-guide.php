...
<body>
  ...
  <section class="users-guide-hero-section" style="background-image: url('images/hero/userGuide/<?php echo $randHero; ?>'); background-size: cover;
  background-repeat: no-repeat;
  background-position: center;">
    <div>
      <h1 class="hero"><?php echo $hero[0]['object']; ?></h1>
      <p class="hero-p"><?php echo $hero[1]['object']; ?></p>
      <a href="users-guide#pre-content"><button><?php echo $hero[2]['object']; ?></button></a>
    </div>
  </section>
  ...
  <section id="order-wfb">
    ...
    <div class="order-steps-wrapper">
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[0]['object']; ?>" alt="Step1">
      </div>
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[1]['object']; ?>" alt="Step2">
      </div>
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[2]['object']; ?>" alt="Step3">
      </div>
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[3]['object']; ?>" alt="Step4">
      </div>
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[4]['object']; ?>" alt="Step5">
      </div>
      ...
      <div>
        <img src="images/user-guide/<?php echo $img[5]['object']; ?>" alt="Step6">
      </div>
    </div>
  </section>
  ...
  <section id="install-wfb">
    ...
    <div class="install-steps-wrapper">
      ...
      <div>
        <video src="videos/user-guide/<?php echo $video[0]['object']; ?>" autoplay controls></video>
      </div>
    </div>
  </section>
