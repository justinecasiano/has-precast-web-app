...
<body>
  ...
  <main>
    <div class="main-header">
      <h1>Content Management - Homepage</h1>
    </div>
    ...
    <div class="table-wrapper">
      <div>
        ...
        <div class="edit-buttons">
          <form action="edit-content.php?page=home" method="post">
            <button type="submit">Edit Page</button>
          </form>
          <a href="includes/content/default-content.inc.php?page=home"><button>Reset to Default</button></a>
        </div>
      </div>
        ...
        <table>
          ...
          foreach($home as $content){
            ...
            if($content['type'] != "TEXT"){
              $object = "
                <img id='media' src='images/index/{$content['object']}'>
              ";
            }
            else{
            ...
            echo "
              <tbody>
                <tr>
                  <td>
                    <a href='includes/content/default-content.inc.php?page=home&section={$content['section']}&name={$content['name']}'>Default</a>
                  </td>
                  <td>
                    $content[section]
                  </td>
