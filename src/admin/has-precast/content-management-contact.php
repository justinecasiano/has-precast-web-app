<?php
  ...
  $contact = $getContent->getPage("contact");
...
<body>
  ...
  <main>
    <div class="main-header">
      <h1>Content Management - Contact Us</h1>
    </div>
    ...
    <div class="table-wrapper">
      <div>
        ...
        <div class="edit-buttons">
          <form action="edit-content.php?page=contact" method="post">
            <button type="submit">Edit Page</button>
          </form>
          <a href="includes/content/default-content.inc.php?page=contact"><button>Reset to Default</button></a>
        </div>
      </div>
      <div class="table">
        <table>
          ...
          foreach($contact as $content){
            echo "
              <tbody>
                <tr>
                  <td>
                    <a href='includes/content/default-content.inc.php?page=contact&section={$content['section']}&name={$content['name']}'>Default</a>
                  </td>
                  <td>
                    $content[section]
                  </td>
