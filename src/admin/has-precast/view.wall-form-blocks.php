...
<body>
    ...
    <div>
      <div class="wfb-content">
        ...
        <div class="wfb-images">
          <img src="images/wall-form-blocks/<?php echo $img[0]['object']; ?>" alt="">
          <img src="images/wall-form-blocks/<?php echo $img[1]['object']; ?>" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="dimension">
    ...
    <div class="dimension-wrapper">
      ...
      <div class="img">
        <img class="main-img" src="images/wall-form-blocks/<?php echo $img[2]['object']; ?>" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="dimension">
    ...
    <div class="dimension-wrapper">
      ...
      <div class="img">
        <img class="main-img" src="images/wall-form-blocks/<?php echo $img[3]['object']; ?>" alt="">
      </div>
    </div>
  </section>
