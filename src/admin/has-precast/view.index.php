<?php
  ...
  if($mediaActualExt === 'webm'){
    ...
    <section class='hero-section'>
      <video muted autoplay controls src='images/hero/home/{$randHero}'></video>
    ...
    $heroMedia = "
      ...
      background-image: url(\"images/hero/home/{$randHero}\");
...
<body>
  ...
  <div class="wrapper">
    ...
    <?php
      echo $heroMedia;
    ?>
    <section class="wall-form-blocks-section" style="background: url('images/index/<?php echo $img[0]['object']; ?>'); background-repeat: no-repeat; background-size: cover; ">
    ...
    <section class="projects-section">
      ...
      <div class="project-view">
        <div class="project" style="background-image: url('images/index/<?php echo $img[1]['object']; ?>');">
        ...
        <div class="project" style="background-image: url('images/index/<?php echo $img[2]['object']; ?>');">
        ...
        <div class="project" style="background-image: url('images/index/<?php echo $img[3]['object']; ?>');">
        ...
        <div class="project" style="background-image: url('images/index/<?php echo $img[4]['object']; ?>');">
    ...
    <section class="contact-section" style="background: url('images/index/<?php echo $img[5]['object']; ?>');">
