...
<head>
  ...
  <link rel="stylesheet" href="/website/assets/styles/base/about-us.css">
</head>
...
<body>
  ...
  <section class="about-us-hero-section" style="background-image: url('admin/has-precast/images/hero/about/<?php echo $randHero; ?>')">
    <div>
  ...
  <section id="about-us-content-wrapper">
    ...
    <div>
      ...
      <div>
        <img src="admin/has-precast/images/temp/about-us/<?php echo $img[0]['object']; ?>">
      </div>
    </div>
  </section>

  <section class="mission-vision" style="<?php echo "background-image: url('admin/has-precast/images/temp/about-us/{$img[1]['object']}')"; ?>">
